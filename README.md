> HTTP Client for seamless authentication handling and pausing/resuming of requests
...
```
### Setup and usage
Setup HTTP client with user CRUD api and autorization - see Examples.swift
